...
const DICT = {
  en: {
    ...
    upContinueTitle: 'Continue chat', upContinueDesc: 'Import a chat, then keep it going live with the other person', upMyRooms: '🔗 My continue-chats',
  ...
  hi: {
    ...
    upContinueTitle: 'चैट जारी रखें', upContinueDesc: 'चैट इम्पोर्ट करें, फिर सामने वाले के साथ लाइव जारी रखें', upMyRooms: '🔗 मेरी जारी चैट',
