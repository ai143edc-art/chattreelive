...
const DICT = {
  en: {
    ...
    upContinueTitle: 'Live chat', upContinueDesc: 'Chat with someone in real time — share a link + PIN, they join in seconds. No import needed.', upMyRooms: '🔗 My continue-chats', upContinueImport: '📎 Continue an exported chat',
  ...
  hi: {
    ...
    upContinueTitle: 'लाइव चैट', upContinueDesc: 'किसी के साथ रियल-टाइम में चैट करें — लिंक + PIN शेयर करें, वो कुछ सेकंड में जुड़ जाता है। कोई इम्पोर्ट नहीं चाहिए।', upMyRooms: '🔗 मेरी जारी चैट', upContinueImport: '📎 एक्सपोर्ट की हुई चैट जारी रखें',
